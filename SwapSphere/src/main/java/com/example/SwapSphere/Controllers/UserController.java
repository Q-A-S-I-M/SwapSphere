...
public class UserController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<User>> searchUsers(@RequestParam String self, @RequestParam String query) {
        return ResponseEntity.ok(userService.searchUsers(self, query));
    }
}
